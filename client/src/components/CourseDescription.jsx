    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <span className="text-gray-700">{courseDetails.language}</span>
        </div>
      </div>
    ...
    <div className="max-w-6xl mx-auto bg-white rounded-laptop shadow-laptop overflow-hidden">
      ...
      <div className="flex flex-col laptop:flex-row gap-6">
        ...
        <div className="flex-1 p-8">
          ...
          {/* Description */}
          <p className="text-gray-700 text-laptop mb-4 leading-relaxed">
            {description}
          </p>
