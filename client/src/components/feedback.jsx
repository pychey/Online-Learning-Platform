const Feedback = () => {
  return (
    ...
    <section className="bg-white text-center py-12 px-4">
      ...
      <h2 className="text-xl sm:text-2xl md:text-4xl font-semibold text-black mb-9">
      ...
      <div className="flex flex-wrap justify-evenly flex-row">
        ...
        <div className="w-full sm:w-1/3 flex flex-col items-center mb-7">
          <p className="text-5xl text-primary font-semibold pb-3">១០០%</p>
        ...
        <div className="w-full sm:w-1/3 flex flex-col items-center mb-7">
          <p className="text-5xl text-primary font-semibold pb-3">៩៧%</p>
