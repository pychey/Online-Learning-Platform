    ...
    <nav className='w-full h-20 border-gray shadow-md fixed top-0 left-0 right-0 bg-white z-50'>
      <div className='flex items-center justify-between max-w-[1100px] mx-auto px-6 tablet:px-2'>
        ...
        <div className="flex laptop:hidden items-center justify-end tablet:gap-6 gap-6 py-5 ">
          ...
          <Link className="h-10 w-10 bg-primary flex items-center justify-center rounded-lg"href={page.login}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='h-8 w-8 text-white'><path fill="currentColor" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4m0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4" /></svg></Link>
        ...
        <div className={`fixed top-0 right-0 h-full w-[70%] max-w-[300px] bg-white z-50 transform transition-transform duration-300 ease-out ${openMenu ? "translate-x-0" : "translate-x-full"} opacity-90 shadow-lg`}>
            ...
            <div className="flex flex-col ">
              ...
              <Link href={page.login} className='bg-primary text-white py-2 px-2 '>ចូលរៀន/ចុះឈ្មោះ</Link>
            </div>
        </div>
      </div>
    </nav>
