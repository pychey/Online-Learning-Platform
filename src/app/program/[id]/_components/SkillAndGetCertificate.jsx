const SkillCertificate = () => {
  return (
    <div className="">
        ...
        <div className=" py-15 border-1 border-gray-200 bg-white rounded-lg flex flex-col items-center">
            <h3 className="text-center font-semibold text-xl tablet:text-2xl pb-4 tablet:pb-0">
                របៀបទទួលបានវិញ្ញាបនបត្រ ACET ACADEMY របស់អ្នក
            </h3>
            <div className="flex flex-col tablet:flex-row items-center mx-auto gap-4 px-4">
                <svg
                ...
                <p className="leading-relaxed text-gray-700 flex-4">
