...
const ProgramOverview = ({ data, admin = false }) => {

  if (data === null) return (<h1>Loading...</h1>)
  return (
    <div className={`${ admin ? "p-8 " : "mt-20 max-w-[1080px] py-5 tablet:py-10" } w-full mx-auto grid grid-cols-1 laptop:grid-cols-[2fr_1fr] gap-6 laptop:gap-8`}>
