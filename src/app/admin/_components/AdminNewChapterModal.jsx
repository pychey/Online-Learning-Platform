...
const AdminNewChapterModal = ({ isOpen, onCancel, onSave }) => {
	...
	return(
		...
		>
			<h1 className="font-semibold text-2xl text-secondary">Create New Chapter</h1>
			...
			<div className="mb-6">
				<h3 className="font-medium mb-2">Chapter Slug</h3>
				<input
					type="text"
					value={slugInput}
...
export default AdminNewChapterModal