...
const AdminNewLessonModal = ({ isOpen, onCancel, onSave }) => {
	...
	return(
		...
		>
			<h1 className="font-semibold text-2xl text-secondary">Create New Lesson</h1>
			...
			<div className="mb-6">
				<h3 className="font-medium mb-2">Lesson Slug</h3>
				<input
					type="text"
					value={slugInput}
...
export default AdminNewLessonModal